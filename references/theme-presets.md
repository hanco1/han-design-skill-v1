...
### User Editorial Warm Beige

Default when the user asks for their editorial house style, warm beige, serif-heavy high-end editorial feeling, or to use this skill for frontend/UI design.
...
- Use `#EFEAE0` as the main warm paper base and `#E5DFD2` for quiet cards or wells.
- Use Source Han Serif / Georgia for title and body authority; use JetBrains Mono only for uppercase overline labels with about `1.5px` letter spacing.
- Highlight only 1-2 keywords with `#CD6F47` or `#6B8A6F`.
- Use 14-16px radii, more than 20% visible whitespace, and `#1A1A1A` emphasis blocks.
- Do not use pure white, `#000000`, gradients, shadows, 3D effects, sans-serif display titles, or all-bold copy.
